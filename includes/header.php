...
<meta charset="utf-8">
  ...
  <title>ULMI/ANMI</title>
  <link type="image/x-icon" href="sistema/img/logo3.png" rel="shortcut icon" />
			...
			<div class="container-fluid d-flex align-items-center justify-content-between">
				<div class="navbar-header">
					<!-- Navbar Header--><a href="index.php" class="navbar-brand">
						<div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">ULMI</strong><strong>ANMI</strong></div>
						<div class="brand-text brand-sm"><strong class="text-primary">U</strong><strong>A</strong></div>
					</a>
					<!-- Sidebar Toggle Btn-->
					<button class="sidebar-toggle"><i class="fas fa-bars"></i></button>
				</div>
				<h4><?php echo fechaHonduras(); ?></h4>
	...
	<div class="d-flex align-items-stretch">
		...
		<nav id="sidebar">
			...
			<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
				...
				<li class="nav-item">
					<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUnidades" aria-expanded="true" aria-controls="collapseUtilities">
						<i class="fas fa-hospital"></i>
						<span>Unidades de Salud</span>
						<i class="fas fa-angle-down fa-lg float-right"></i>
					</a>
					<div id="collapseUnidades" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							<a class="collapse-item" href="listar_hospital.php">Hospitales</a>
							<a class="collapse-item" href="listar_regiones.php">Regiones</a>
							<a class="collapse-item" href="listar_regiones.php">Centros de salud</a>
						</div>
					</div>
				</li>

				<li class="nav-item">
					<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsecomponet" aria-expanded="true" aria-controls="collapseUtilities">
						<i class="fas fa-hospital"></i>
						<span>Componentes</span>
						<i class="fas fa-angle-down fa-lg float-right"></i>
					</a>
					<div id="collapsecomponet" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							<a class="collapse-item" href="tablero.php">Tablero de mando</a>
							<a class="collapse-item" href="listar_citas.php">Citas a proveedores</a>
							<a class="collapse-item" href="#">Estatus de compras</a>
						</div>
					</div>
				</li>
				...
				<li class="nav-item">
					...
					<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							...
							<a class="collapse-item" href="lista_productos.php">Insumos</a>
						</div>
					</div>
				</li>
